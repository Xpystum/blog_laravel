<a data-tooltip-target="tooltip-svg-sketch" href="#"
    class="relative p-1 block hover:bg-gray-700 rounded-md">
    <svg width="24" height="24" class="_o2IXcpM0qnG3JPReKus E9GV5sZJIbfO_GEQ_moc" aria-hidden="true" viewBox="0 0 18 17" fill="none"
