...
<div class="w-full">
    ...
    <x-input placeholder="{{ $attributes->get('placeholder') }}" :autofocus="$autofocus" :type="$type" :name="$name" :id="$name" class="w-full bg-gray-50 border border-gray-300 text-gray-900
