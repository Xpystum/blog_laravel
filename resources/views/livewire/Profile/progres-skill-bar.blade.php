        ...
        <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
            ...
            <div class="flex flex-col mb-3">
                ...
                <div class="mt-6 mb-2">
                    <x-union.union-skill-progress-svg class_name="progres_slider_skill" class_value_progress_bar="mx-6"
                        input_name="css">
                        <x-svg.css width='36' height='36' data_tooltip_target="tooltip-svg-css-skill-progress" />
                    </x-union.union-skill-progress-svg>
                </div>
                ...
                <div class="mt-6 mb-2">
                    <x-union.union-skill-progress-svg class_name="progres_slider_skill" class_value_progress_bar="mx-6"
                        input_name="php">
                        <x-svg.php width='36' height='36' data_tooltip_target="tooltip-svg-php-skill-progress" />
                    </x-union.union-skill-progress-svg>
                </div>
                ...
                <div class="mt-6 mb-2">
                    <x-union.union-skill-progress-svg class_name="progres_slider_skill"
                        class_value_progress_bar="mx-6" input_name="react">
                ...
                <div class="mt-6 mb-2">
                    <x-union.union-skill-progress-svg class_name="progres_slider_skill"
                        class_value_progress_bar="mx-6" input_name="sketch">
                ...
                <div class="mt-6 mb-2">
                    <x-union.union-skill-progress-svg class_name="progres_slider_skill"
                        class_value_progress_bar="mx-6" input_name="typescript">
                ...
                <div class="mt-6 mb-2">
                    <x-union.union-skill-progress-svg class_name="progres_slider_skill"
                        class_value_progress_bar="mx-6" input_name="sql">
