<div>
    ...
    @php
        ...
        $fileUrl =
            isset($post) && $post?->cover_img
                ? Storage::disk('post_image_cover')->url($post->cover_img->path_url)
                : null;
    @endphp

    <x-errors.errors />

    <x-input.input :value="isset($post) && isset($post['title']) ? $post['title'] : null" name="title" placeholder="Заголовок Cтатьи"
        class="w-full p-3 mb-2 bg-gray-50 border border-gray-300 text-gray-900
    ...
    @isset($fileUrl)
        <div class="flex flex-row">
            ...
            <a href="{{ $fileUrl }}" target="_blank" class="ml-2 text-center mb-2 text-blue-500 underline">Посмотреть
                загруженный файл</a>
        </div>
    @else
        <x-input.input-file :value_text="'Загрузить файл обложки'" class="mb-2" accept="image/*" name="cover_img_post" />
    @endisset
    ...
    <div class="flex flex-col w-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="px-3 py-2 border-b dark:border-gray-600">
            <div class="flex flex-wrap items-center">
                <div class="flex flex-nowrap justify-between w-full">
                    ...
                    <div class="flex space-x-1 rtl:space-x-reverse flex-wrap items-center">
                    ...
                    <div>
                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" id="removeContentButton" type="button" data-tooltip-target="tooltip-remove-content"
                        class="p-1.5 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">

                            <svg class="w-5 h-5" aria-hidden="true" width="24"
                                xmlns="http://www.w3.org/2000/svg" height="24" fill="none"
                                viewBox="0 0 448 512">
                                <path fill="#74C0FC" stroke="currentColor" stroke-linecap="round"
                                stroke-linejoin="round" stroke-width="2" d="M135.2 17.7C140.6 6.8 151.7 0 163.8 0L284.2 0c12.1 0 23.2 6.8 28.6 17.7L320 32l96 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 96C14.3 96 0 81.7 0 64S14.3 32 32 32l96 0 7.2-14.3zM32 128l384 0 0 320c0 35.3-28.7 64-64 64L96 512c-35.3 0-64-28.7-64-64l0-320zm96 64c-8.8 0-16 7.2-16 16l0 224c0 8.8 7.2 16 16 16s16-7.2 16-16l0-224c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16l0 224c0 8.8 7.2 16 16 16s16-7.2 16-16l0-224c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16l0 224c0 8.8 7.2 16 16 16s16-7.2 16-16l0-224c0-8.8-7.2-16-16-16z"/>
                            </svg>

                            <span class="sr-only">Удалить контент редактора</span>
                        </button>

                        <div id="tooltip-remove-content" role="tooltip"
                            class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
        ...
        <button id="text-editor__tiptap-button" type="submit"
            class="ml-auto m-3 py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal">
                    ...
                    <span class="sr-only">Закрыть Модальное окно удаление контента</span>
                </button>
                <div class="p-4 md:p-5 text-center">
                    <svg class="mx-auto mb-4 text-gray-400 w-12 h-12 dark:text-gray-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 11V6m0 8h.01M19 10a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                    </svg>
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Вы дейсвтительно хотите очистить контент? у вас очистятся данные в редакторе...</h3>
                    <button id="popup-modal-remove-content-tiptap" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Да, удалить контент.
                    </button>
