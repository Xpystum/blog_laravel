    ...
    <nav class="backdrop-blur-md h-custom-height dark:bg-dark-gray-opacity text-white shadow-md fixed w-full z-20 top-0 start-0">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex space-x-3 rtl:space-x-reverse">
                <a href="{{ route('register') }}" class="w-custom-width-button-linktext-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Регистрация</a>
                <a href="{{ route('login') }}" class="w-custom-width-button-link text-white bg-blue-700 hover:bg-blue-800 focus:ring-4
